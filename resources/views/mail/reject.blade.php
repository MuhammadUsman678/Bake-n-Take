                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="text-center pb25" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:30px; text-align:center; padding-bottom:25px;">
                                                                <p>Hi {{ $maildetail['username'] }} your Shop {{ $maildetail['shop_name'] }} account was Suspended From Bake'n Take site You Can now Contact our team for furthure information.</p>
