          ...
          <nav id="sb-dynamic-menu" class="sb-menu-transition">
            <ul class="sb-navigation">
              <li class="sb-has-children">
                <a data-no-swup="" id="mhome" href="{{ url('/') }}">Home</a>
              </li>
              <li class="sb-has-children">
              ...
              <li class="sb-has-children">
                <a data-no-swup="" id="mshop" href="{{url('all_shop')}}">Shop</a>
              </li>
              <li class="sb-has-children">
                <a data-no-swup="" id="mproducts"  href="{{ route('front.all.products')}}">Products</a>
              </li>
