                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <p class="card-text text-primary">First Image will be used as Product Main Images .</p>
...
<script>
  ...
  Dropzone.options.fileDropzone = {
    url: '{{ route('shop.products.store',[$id]) }}',
    // maxFiles:maxFiles,
    ...
    init: function() {
        ...
        $.ajax({
        type: 'GET',
        url: '{{ route("shop.products.exists",[$id]) }}',
        ...
        success: function (data){
            ...
            $.each(data, function(key,value){
                dropzone_files.push({'new_name': value.name, 'old_name': value.name});
                 ...
                 thisDropzone.options.thumbnail.call(thisDropzone, mockFile,"{{ url('/') }}"+'/'+value.url);
    ...
    //   console.log(file_name)
      $.ajax({
        type: 'POST',
        url: '{{ route("shop.products.remove") }}',
